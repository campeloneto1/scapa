...
export class FormularioSexosCompoennt implements OnInit {
  form!: FormGroup;
  ...
  cadastrar(){  
    ...
    if(this.form.value.id){
      this.sexosService.update(this.form.value).subscribe({
        next: (data) => {
      ...
      this.sexosService.store(this.form.value).subscribe({
        next: (data) => {
          //console.log('aaaaaaaaaa')
